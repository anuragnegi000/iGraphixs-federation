...
const validationSchema = Yup.object().shape({
  ...
  currency: Yup.string().required("Payment currency is required"),
  attachment: Yup.mixed().required("Attachment is required"),
  suggestion1: Yup.string().required("Suggestion 1 is required"),
              ...
              <Form className="sm:flex sm:flex-col md:grid grid-row-3 md:gap-2  gap-4 bg-transparent rounded-lg ">
                <div className="mb-4">
                  ...
                  <ErrorMessage
                    name="name"
                    component="div"
                    className="text-red-600 text-opacity-10"
                  />
                </div>
                <div className="mb-4">
                  <label
                ...
                <div className="mb-4">
                  <label
                    htmlFor="email"
                    className="block text-white  bg-transparent rounded-lg border-t-blue-300 border-b-pink-300"
                  >
                    Email:
                  </label>
                  <Field
                ...
                <div className="mb-4 ">
                  ...
                  <Field
                    ...
                    id="country"
                    name="country"
                    className="input-field bg-black w-48 text-white  rounded-lg border-t-blue-300 border-b-pink-300"
                  >
                ...
                <div className="mb-4">
                  ...
                  <Field
                    ...
                    id="currency"
                    name="currency"
                    className="input-field bg-black  text-white  rounded-lg border-t-blue-300 border-b-pink-300"
                  >
                ...
                <div className="mb-4 col-span-2">
                  <label htmlFor="suggestion1" className="block   ">
                    Suggestion 1:
                  </label>
                  <Field
                    as="textarea"

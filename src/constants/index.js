...
export const roadmap = [
  {
    id: "0",
    title: "SOUL ESPORTS",
    text: "Soul esports are one of the biggest esports organisations of BGMI ( pubg ). Handled the creatives of ex-soul members to produce high quality content tailored to engage and captivate the esports community",
    date: "January 2023",
    status: "done",
    imageUrl: roadmap1,
    colorful: true,
  },
  {
    ...
    text: "Contributing them as Animation and graphics artist in the creation of dynamic visuals and animations tailored to enhance engagement on social media.",
    date: "in progress",
    status: "Working with",
    imageUrl: roadmap2,
  },
  {
    ...
    text: "Helped him in handling content management & Strategies, Editing & Thumbnail Strategies, Planning & more.! Shaped the visual idenity of @Sid & Sid Reacts.",
    date: "December 2023",
    status: "done",
    imageUrl: roadmap3,
  },
...
export const collabText =
  "Creative Designs,To meet your imagination into reality with top notch works.";
...
export const benefits = [
  {
    ...
    url: "https://www.behance.net/gallery/196975275/YT-Thumbnails",
  },
  {
    id: "1",
